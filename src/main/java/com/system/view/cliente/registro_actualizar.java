...
import static com.system.view.cliente.VistaCliente.PanelVistaCliente;
...
public class registro_actualizar extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jtex_nunnciado_registro.setText("REGSITRO DE CLINETE ");
    ...
    private void cargar_campos(boolean estado) {
        if (VistaCliente.estado == true) {
            ...
            this.jtex_dni.setText(lista_eliminar.doc);
